	  ...
	  if (dictionarysym[i] == x)
	    {
	      if ((i + n) > 32)
		{
		  finalstr = finalstr + dictionarysym[(i + n) % 32];
		  k = k + 1;
		}
	      else
		{
		  finalstr = finalstr + dictionarysym[(i + n)];
		  k = k + 1;
		}
	    }
	}
	  ...
	  if (dictionary[i] == x)
	      ...
	      else
		{
		  ...
		  if (quo == 0)
		    ...
		    {
		      finalstr = finalstr + dictionary[(26 * quo) + i - n];
		      k = k + 1;
		    }
		}
	    }
	      ...
	      else
		{
		  ...
		  if (quo == 0)
		    ...
		    {
		      finalstr = finalstr + dictionary1[(26 * quo) + i - n];
		      k = k + 1;
		    }
	  ...
	  if (dictionarynum[i] == x)
	      ...
	      else
		{
		  ...
		  if (quo == 0)
		    ...
		    {
		      finalstr = finalstr + dictionarynum[(9 * quo) + i - n];
		      k = k + 1;
		    }
		}
	    }
      ...
      for (int i = 1; i < 33; i++)
	{
	  if (dictionarysym[i] == x)
	      ...
	      else
		{
		  ...
		  if (quo == 0)
		    {
		      finalstr = finalstr + dictionarysym[32 + i - n];
		      k = k + 1;
		    }
		  else
		    {
		      finalstr = finalstr + dictionarysym[(32 * quo) + i - n];
		      k = k + 1;
		    }
		}
	    }
